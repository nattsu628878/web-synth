/**
 * 4次CRローパスフィルタ (four-pole LPF)
 * 1次LPF を4段直列。a = 1 - exp(-2π*fc/fs) → -24 dB/oct
 */

class FourPoleLpfProcessor extends AudioWorkletProcessor {
...
registerProcessor('four-pole-lpf', FourPoleLpfProcessor);
