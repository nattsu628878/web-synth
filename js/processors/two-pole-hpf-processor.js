/**
 * 2次CRハイパスフィルタ (two-pole HPF)
 * 2次LPF の出力を入力から引く。y1 = a*x + (1-a)*y1_prev, y2 = a*y1 + (1-a)*y2_prev, out = x - y2
 * a = 1 - exp(-2π*fc/fs) → -12 dB/oct
 */

class TwoPoleHpfProcessor extends AudioWorkletProcessor {
...
registerProcessor('two-pole-hpf', TwoPoleHpfProcessor);
